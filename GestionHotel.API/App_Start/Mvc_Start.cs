...
using GestionHotel.Domain.Validations.Espace;
using MediatR;
...
namespace GestionHotel.API.App_Start
{
    public static class Mvc_Start
    {
        ...
        public static void UseDefaultAndCors(this IServiceCollection services, IConfiguration Configuration)
        {
            ...
            //Load dynamically
            var assemblyV1 = typeof(GestionHotel.API.V1.Controllers.ApiV1ControllerBase).Assembly;
            ...
            {
                opt.RegisterValidatorsFromAssembly(Assembly.GetAssembly(typeof(CreateEspaceValidation)));
            })
        ...
        public static void UseAllMVCAndRouting(this IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            //app.UseAutoMigrateDatabase<GestionHotel_DBContext>();
